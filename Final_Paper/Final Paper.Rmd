...
If you are using a mac, you must install XQuartz before loading imager. It is a download that was created by Apple as "a community effort to fruther develop and support X11 on Mac", something which is no longer included with Macs (Mac Support). XQuartz can be downloaded [here](https://www.xquartz.org). 
